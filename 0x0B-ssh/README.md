...
## Background Context
Along with this project, you have been attributed an Ubuntu server, living in a datacenter far far away. Like level 2 of the application process, you will connect using ssh. But contrary to level 2, you will not connect using a password but an RSA key. The server is configured with the public key you created in the first task of a previous project.
...
**Solution [0-use_a_private_key](0-use_a_private_key)**
...
**Solution [1-create_ssh_key_pair](1-create_ssh_key_pair)**
...
**Solution [2-ssh_config](2-ssh_config)**
...
**Solution [100-puppet_ssh_config.pp](100-puppet_ssh_config.pp)**
